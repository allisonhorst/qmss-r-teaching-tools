...
ahorst@ucsb.edu | Twitter: [@allison_horst](https://twitter.com/allison_horst) | Website: [allisonhorst.com](https://www.allisonhorst.com/)

---

# Hello!

- Assistant Teaching Professor (Bren) - Environmental Data Science
- Me: 10 years teaching in R (introductory & advanced courses)
...
- Data science / coding skills ubiquitously valuable
- More and more, instructors and TAs incorporating into classes
- Teaching R (or any programming) can be its own beast
- Here are some things that work well for me

**Big side note:** There are *many* ways to teach R & data science well. I recommend following and keeping up to date with
...
Or create ggplot artwork, for example inspired by [Ijeamaka Anyene](https://ijeamaka-anyene.netlify.app/):
...
Slide with code and outputs, easily updated.
