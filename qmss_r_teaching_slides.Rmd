---
title: "Teaching tips for introducing R"
...
- ### 4 strategies to get hesitant students on board

- ### 3 tools to make your life easier...when teaching and otherwise

- ### 2 tools to get learners up-and-running

---

class: inverse, center, middle

## 4 strategies to get hesitant students on board with R
...
- A ggplot graph (or better, a map)
- Add an image (e.g. a from the GitHub Octodex)\
- R Markdown fancy (themes, tabs, TOC, code folding)

---

## 2. Engage more students with creative activities

- Generative artwork with an existing package
- Worst data visualization activity

---

## 3. Help them build a kitchen

- Update IDE theme
- R Markdown + visual editor
- Rainbow parentheses
- R Projects + better file paths with `here::here()`

---

## 4. Write code together

- Not just pressing 'Run'
- You type & explain, then they type - line by line
- Bring printed + annotated notes for yourself
...
## 3 tools that might make you life easier

- {xaringan} for slides
- {distill} for sturdy, simple websites
- GitHub Classroom for assignment distribution
