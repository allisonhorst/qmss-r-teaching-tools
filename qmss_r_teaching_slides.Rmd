---
title: "Teaching R: Tips, Tools & Strategies"
...
- ### Teaching strategies for beginning R users

- ### Useful tools to get over installation barriers

- ### Building a data science kitchen

- ### Use existing tutorials

- ### Tools to make your own life easier

---

## First day of Coding 101
...
## Instead: get them on board early with a big win (even running pre-prepared code to make a cool graph, or map, or something)

---

## Help them build a kitchen

- Rainbow parentheses
- Update IDE theme
- IDE font
- R Markdown's visual editor
...
- Not just press 'Run'
- You type & explain, then they type - everything
- Bring printed notes! Don't stress yourself out! 
