...
2. `r emo::ji("computer")` [GitHub Pages](https://pages.github.com/) to share keys (deploy from any branch!)
3. `r emo::ji("book")` Use existing teaching materials
...
# A few (of many) teachers I learn from: 

[Mine Cetinkaya-Rundel](https://mine-cr.com/) | [Tiffany Timbers](https://www.tiffanytimbers.com/) | [Greg Wilson](https://third-bit.com/)
